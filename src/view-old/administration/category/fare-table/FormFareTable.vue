                ...
                >
                  ...
                  >
                    <el-select
                      ...
                      :disabled="(isEdit && row.isEdit) || isView"
                    >
                      <el-option
...
const typeVehicle = ref([
  {
    type: 'TYPE_1',
    name: t('omsSetting.type', ['1']),
  },
  {
    type: 'TYPE_2',
    name: t('omsSetting.type', ['2']),
  },
  {
    type: 'TYPE_3',
    name: t('omsSetting.type', ['3']),
  },
  {
    type: 'TYPE_4',
    name: t('omsSetting.type', ['4']),
  },
  {
    type: 'TYPE_5',
    name: t('omsSetting.type', ['5']),
  },
])
...
const getCode = () => {
  apiGenCategoryCode(3)
    .then(res => {
      infoFareTable.value.code = res.data
    })
    .catch(_ => {
      ElMessage({
        type: 'error',
