  ...
  <div class="report-station">
    ...
    <div class="bg-white paddingX-16 paddingY-12">
      <el-table
        ...
        max-height="680px"
        class="cell-main-3-to-3 cell-main-8-to-8"
...
import { fetchReportVehicleStation, exportReportVehicleStation } from '@/api/report.js'
...
const listColumns = ref([
  ...
  {
    prop: 'countLevelOverloadTT46NoPenalty',
    label: 'report.violationsNotToPenalty46',
    align: 'center',
    headerAlign: 'center',
  },
  {
    prop: 'countLevelOverloadDKNoPenalty',
    label: 'report.violationsNotToPenaltyDK',
    align: 'center',
    headerAlign: 'center',
  },
  {
...
const getList = async () => {
  ...
  try {
    ...
    const { data } = await fetchReportVehicleStation(param)
...
const handleExport = async () => {
  ...
  try {
    const param = getParamFilter()
    const { data } = await exportReportVehicleStation(param)
    if (data) {
