...
const utils = {
  ...
  fetchOWMWeather: (opts = {}) => {
    ...
    return fetch(
      `${import.meta.env.VITE_APP_WEATHER_MAP_URL}?appid=${opts.apiKey}` +
        `&lat=${opts.lat}` +
        `&lon=${opts.lng}` +
        `&units=${units}` +
        `&lang=${opts.language}`
  ...
  fetchCustomWeather: (opts = {}) => {
    ...
    return fetch(
      import.meta.env.VITE_APP_WEATHER_MAP_URL +
        `?appid=${import.meta.env.VITE_APP_OPENWEATHER_APIKEY}` +
        `&lat=${opts.lat}` +
        `&lon=${opts.lng}` +
        `&units=${units}` +
        `&lang=${opts.language}`
