...
export default class Stream {
    ...
    onContainerResize(dstSize) {
        if (this.videoConnection) {
            XPMobileSDKTunnel.changeStream(this.videoConnection, {}, dstSize);
    ...
    start(videoConnection) {
        ...
        } else if (window.XPMobileSDKTunnel) {
            this.requestStream = XPMobileSDKTunnel.requestStream(this.cameraId, destination, parameteres, this.streamReady.bind(this), this.streamError.bind(this));
        }
    ...
    onLiveEvents(current) {
        ...
        if (changed & XPMobileSDKTunnel.library.ItemHeaderParser.LiveFlags.CameraConnectionLost) {
            if (current & XPMobileSDKTunnel.library.ItemHeaderParser.LiveFlags.CameraConnectionLost) {
    ...
    destroy(keepVideoConnection) {
        ...
        if (this.requestStream) {
            XPMobileSDKTunnel.cancelRequest(this.requestStream);
            this.requestStream = null;
        }
