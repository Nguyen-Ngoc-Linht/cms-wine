...
// console.log("asdfasdfsdf:", VideoStreamState)

class VideoStreamTunnel {
	constructor(videoId, connectionRequest, callbacks) {
		...
		this.videoConnectionElement.location = XPMobileSDKSettingsTunnel.MobileServerURL + XPMobileSDKSettingsTunnel.videoChanel;
		...
		// console.log("test elemtnasdfsdfd00000000000000000000:",videoConnectionManagerElement)
	...
	close() {
		...
		XPMobileSDKTunnel.closeStream(this.videoId);
		this.state = 2;
	}
