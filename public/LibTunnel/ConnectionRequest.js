; (function (undefined) {
     ...
     */
    var connectionRequestTunnel = function (command, sequenceID, params, options, callback) {

        var self = this;

        XPMobileSDKTunnel.addObserver(this);
        ...
        var connectionURL = parseURL(XPMobileSDKTunnel.library.Connection.server) + XPMobileSDKSettingsTunnel.communicationChanel;
        ...
        function initializeAjaxRequest() {
            ...
            ajaxRequest = XPMobileSDKTunnel.library.Ajax.Request(connectionURL, {
        ...
        function onComplete(response) {
            ...
            if (command == 'LiveMessage' &&
                (Date.now() - lastLiveMessageRequestTimestamp < XPMobileSDKSettingsTunnel.liveMessageMinimumInterval)) {
                return;
            }
        ...
        function parseResponse() {
            ...
            while ((i = responseText.indexOf("\r\n\r\n", responseOffset)) > 0) {
                ...
                if (xml) {
                    var response = new XPMobileSDKTunnel.library.ConnectionResponse(xml);
        ...
        function generateData() {
            ...
            for (key in params) {
                var createProperty = function (key, value) {
                    value = (value !== undefined && value !== null && value.toString) ? value.toString() : '';
            ...
            return '<?xml version=\"1.0\" encoding=\"utf-8\"?>' +
                ...
                (XPMobileSDKTunnel.library.Connection.connectionId ? '<ConnectionId>' + XPMobileSDKTunnel.library.Connection.connectionId + '</ConnectionId >' : '') +
    ...
    XPMobileSDKTunnel.library.ConnectionRequest = connectionRequestTunnel;
})();