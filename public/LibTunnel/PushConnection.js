XPMobileSDKTunnel.library.PushConnectionObserverInterface = {
...
XPMobileSDKTunnel.library.PushConnection = function (videoURL, options) {
    ...
    this.videoConnectionState = XPMobileSDKTunnel.library.VideoConnectionState.notOpened;
    ...
    this.startCommunication = function () {
        ...
        if (socketFailedTimestamp) {
            ...
            if (Date.now() - socketFailedTimestamp < XPMobileSDKSettingsTunnel.videoStreamRestartMinimumInterval) {
                setTimeout(function () {
                    console.warn("Restarting socket.");
                    createSocket();
                }.bind(this), XPMobileSDKSettingsTunnel.socketRestartMinimumInterval);
            }
            else {
    ...
    var createSocket = function () {
        ...
        try {
            ...
            if (this.videoConnectionState == XPMobileSDKTunnel.library.VideoConnectionState.closed) {
                return;
            }
    ...
    var onMessage = function (event) {
        ...
        lastFrame = new XPMobileSDKTunnel.library.VideoHeaderParser(event.data);
    ...
    var onClose = function (event) {
        ...
        if (this.videoConnectionState == XPMobileSDKTunnel.library.VideoConnectionState.running && XPMobileSDKTunnel.library.Connection.connectionId) {
