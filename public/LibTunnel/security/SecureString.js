 ...
 * @author 		tvh
 */
XPMobileSDKTunnel.library.SecureString = {
	...
	generateKey: function() {
		var sharedKey = '';
		if(!this.sharedKey) {
		    if (XPMobileSDKTunnel.library.Connection.dh) {
			    sharedKey = this.sharedKey = XPMobileSDKTunnel.library.Connection.dh.getSharedKey().toUpperCase();
			}
		    else if (XPMobileSDKTunnel.library.CHAP.sharedKey) {
		        sharedKey = this.sharedKey = XPMobileSDKTunnel.library.CHAP.sharedKey.toUpperCase();
			}
		}
		else {
