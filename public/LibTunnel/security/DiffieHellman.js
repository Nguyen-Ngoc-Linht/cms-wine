...
XPMobileSDKTunnel.library.DiffieHellman = function(params) {
	/**
	 ...
	 * @access		private
	 */
    var primeKeyBigInt = str2bigInt(primeKey[XPMobileSDKSettingsTunnel.primeLength], 16, 1);
	...
	this.encodeString = function(str) {
		...
		var params = { 'iv': iv };
		if (XPMobileSDKSettingsTunnel.defaultEncryptionPadding && CryptoJS.pad[XPMobileSDKSettingsTunnel.defaultEncryptionPadding]) {
		    params.padding = CryptoJS.pad[XPMobileSDKSettingsTunnel.defaultEncryptionPadding];
		}
