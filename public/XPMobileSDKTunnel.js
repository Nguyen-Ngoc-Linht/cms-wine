/**
 * @namespace
 * @property {object}  XPMobileSDKSettingsTunnel                                        - The default values for settings.
 * @property {string}  XPMobileSDKSettingsTunnel.fileName                                - Name of the main file
 * @property {string}  XPMobileSDKSettingsTunnel.clientType                            - Client type
 * @property {string}  XPMobileSDKSettingsTunnel.communicationChanel                    - URL path of communication channel
 * @property {string}  XPMobileSDKSettingsTunnel.videoChanel                            - URL path of video channel
 * @property {string}  XPMobileSDKSettingsTunnel.audioChannel                            - URL path of audio channel
 * @property {string}  XPMobileSDKSettingsTunnel.MobileServerURL                        - URL of Mobile Server
 * @property {string}  XPMobileSDKSettingsTunnel.defaultEncryptionPadding                - default Encryption Padding
 * @property {number}  XPMobileSDKSettingsTunnel.primeLength                            - prime length
 * @property {number}  XPMobileSDKSettingsTunnel.videoConnectionTimeout                - video connection timeout
 * @property {number}  XPMobileSDKSettingsTunnel.resamplingFactor                        - resampling factor
 * @property {number}  XPMobileSDKSettingsTunnel.liveMessageMinimumInterval            - live message minimum interval
 * @property {number}  XPMobileSDKSettingsTunnel.socketRestartMinimumInterval            - socket restart minimum interval
 * @property {number}  XPMobileSDKSettingsTunnel.videoStreamRestartMinimumInterval    - video stream restart minimum interval
 * @property {boolean}  XPMobileSDKSettingsTunnel.supportsMultiThreaded                - Flag indicating whether Multi thread is enabled
 * @property {boolean}  XPMobileSDKSettingsTunnel.supportsCarousels                    - Flag indicating whether Carousels is enabled
 * @property {boolean}  XPMobileSDKSettingsTunnel.supportsCHAP                        - Flag indicating whether CHAP is enabled
 * @property {boolean}  XPMobileSDKSettingsTunnel.DirectStreaming                        - Flag indicating whether Direct streaming is enabled
 * @property {boolean}  XPMobileSDKSettingsTunnel.SupportsAudioIn                        - Flag indicating whether Audio In is enabled
 * @property {boolean}  XPMobileSDKSettingsTunnel.SupportsAudioOut                    - Flag indicating whether Audio Out is enabled
 * @property {number}  XPMobileSDKSettingsTunnel.AudioCompressionLevel                - Audio Compression Level when using browsers build in audio player
 * @property {number}  XPMobileSDKSettingsTunnel.AudioCompressionLevelAudioAPI        - Audio Compression Level when using Web Audio API
 * @property {number}  XPMobileSDKSettingsTunnel.NoVideoTimeout                        - No Video Timeout
 * @property {boolean|string}  XPMobileSDKSettingsTunnel.EnableConsoleLog                - possible values: true, false, "error", "warn", "info", "log". "log", "info" and true are basically the same. All other values will be interpreted as true.
 * @property {boolean}  XPMobileSDKSettingsTunnel.SupportsAdaptiveStreaming            - Flag indicating whether Adaptive Streaming is enabled
 */
var XPMobileSDKSettingsTunnel = {

    fileName: 'XPMobileSDKTunnel.js',
    ...
    includes: [
        /* [MINIFY_JS] */
        'LibTunnel/tools/logging.js',
        'LibTunnel/tools/polyfills.js',
        'LibTunnel/tools/webStorage.js',

        'LibTunnel/security/BigInt.js',
        'LibTunnel/security/Base64.js',
        'LibTunnel/security/AES.js',
        'LibTunnel/security/SHA256.js',
        'LibTunnel/security/SHA512.js',
        'LibTunnel/security/SecureString.js',
        'LibTunnel/security/CHAP.js',
        'LibTunnel/security/Challenge.js',
        'LibTunnel/security/DiffieHellman.js',
        'LibTunnel/security/ISO10126.js',

        'LibTunnel/communication/Ajax.js',
        'LibTunnel/communication/Bytes.js',
        'LibTunnel/communication/NetworkConfig.js',
        'LibTunnel/communication/CommunicationStability.js',

        'LibTunnel/Connection.js',
        'LibTunnel/ConnectionRequest.js',
        'LibTunnel/ConnectionResponse.js',
        'LibTunnel/PullConnection.js',
        'LibTunnel/PushConnection.js',
        'LibTunnel/VideoConnection.js',
        // 'LibTunnel/VideoStream.js',
        'LibTunnel/ItemHeaderParser.js',
        'LibTunnel/VideoHeaderParser.js',
        'LibTunnel/AudioHeaderParser.js',
        'LibTunnel/VideoConnectionPool.js',
        'LibTunnel/VideoPushConnection.js',
        'LibTunnel/AudioPushConnection.js'
        /* [/MINIFY_JS] */
    ]
};
var XPMobileSDKTunnel = new function () {
    ...
    function initialize() {
        var script = document.querySelector('script[src$="' + XPMobileSDKSettingsTunnel.fileName + '"]');

        path = script.src.replace(RegExp(XPMobileSDKSettingsTunnel.fileName + '.*$'), '');
        head = document.querySelector('head');

        load(XPMobileSDKSettingsTunnel.includes.slice());
    }

    //CustomLoadDone truonghh
    function loadDone(loadDoneCallback) {
        loadDoneCallback();
    }
    ...
    function loadComplete() {
        XPMobileSDKTunnel.library.Connection = new ConnectionTunnel();
        XPMobileSDKTunnel.library.CHAP.initialize();
        XPMobileSDKTunnel.library.Connection.initialize(XPMobileSDKTunnel.localStorage);
        loaded = true;
        setTimeout(function () {
            var event = new CustomEvent("loadCompleteEventTunnel", {
                detail: {
                    cameraId: null,
                },
            });
     ...
     *                  (for example XPMobileSDKTunnel.localStorage, XPMobileSDKTunnel.sessionStorage,
    ...
    function initializeConnection(storage) {
        XPMobileSDKTunnel.library.Connection.initialize(storage);
    }
    ...
    function addObserver(observer) {
        if (XPMobileSDKTunnel.library.Connection) {
            XPMobileSDKTunnel.library.Connection.addObserver(observer);
        }
    ...
    function removeObserver(observer) {
        XPMobileSDKTunnel.library.Connection.removeObserver(observer);
    }
    ...
    function cancelRequest(request) {
        XPMobileSDKTunnel.library.Connection.cancelRequest(request);
    }
    ...
    function connect(server) {
        if (server) {
            XPMobileSDKTunnel.library.Connection.server = server;
        }
    ...
    function Connect(params, successCallback, failCallback) {
        params = params || {};
        params.PublicKey = XPMobileSDKTunnel.library.Connection.dh.createPublicKey();
        if (XPMobileSDKSettingsTunnel.primeLength) {
            params.PrimeLength = XPMobileSDKSettingsTunnel.primeLength;
        }
        if (XPMobileSDKSettingsTunnel.defaultEncryptionPadding) {
            params.EncryptionPadding = XPMobileSDKSettingsTunnel.defaultEncryptionPadding.toUpperCase();
        }

        var connectionRequest = XPMobileSDKTunnel.library.Connection.Connect(params, successCallback, failCallback);
        return connectionRequest || XPMobileSDKTunnel.interfaces.ConnectionRequest;
    }
    ...
    function connectWithId(server, connectionId, serverId) {
        XPMobileSDKTunnel.library.Connection.connectWithId(server, connectionId, serverId);
    }
    ...
    function Login(params, successCallback, failCallback) {
        ...
        if (XPMobileSDKTunnel.library.Connection.PublicKey) {
            params.Username = XPMobileSDKTunnel.library.Connection.dh.encodeString(params.Username);
            params.Password = XPMobileSDKTunnel.library.Connection.dh.encodeString(params.Password);
        }

        if (XPMobileSDKSettingsTunnel.supportsCHAP && XPMobileSDKTunnel.library.Connection.CHAPSupported == 'Yes') {
        ...
        if (XPMobileSDKSettingsTunnel.supportsCarousels) {
            params.SupportsCarousel = params.SupportsCarousel || 'Yes';
        }
        if (XPMobileSDKSettingsTunnel.clientType) {
            params.ClientType = params.ClientType || XPMobileSDKSettingsTunnel.clientType;
        }

        var connectionRequest = XPMobileSDKTunnel.library.Connection.Login(params, successCallback, failCallback);
        return connectionRequest || XPMobileSDKTunnel.interfaces.ConnectionRequest;
    }
    ...
    function requestCode(successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.requestCode(successCallback, errorCallback);
    }
    ...
    function verifyCode(code) {
        return XPMobileSDKTunnel.library.Connection.verifyCode(code);
    }
     ...
     */
    function disconnect() {
        XPMobileSDKTunnel.library.Connection.Disconnect();
    }
    ...
    function Disconnect(params, successCallback, failCallback) {
        XPMobileSDKTunnel.library.Connection.Disconnect(params, successCallback, failCallback);
    }
     ...
     *
     * @example setInterval(function(){XPMobileSDKTunnel.LiveMessage()}, 24000);
     *
     * @method Disconnect
     * @param {Object} params - Parameters to sent to the server.  May contain:
     * <pre>
    ...
    function LiveMessage(params, successCallback, failCallback) {
        XPMobileSDKTunnel.library.Connection.LiveMessage(params, successCallback, failCallback);
    }
    ...
    function getAllViews(successCallback, errorCallback) {
        var connectionRequest = XPMobileSDKTunnel.library.Connection.getAllViews(successCallback, errorCallback);
        return connectionRequest || XPMobileSDKTunnel.interfaces.ConnectionRequest;
    }
    ...
    function getViews(viewId, successCallback, errorCallback) {
        var connectionRequest = XPMobileSDKTunnel.library.Connection.getViews(viewId, successCallback, errorCallback);
        return connectionRequest || XPMobileSDKTunnel.interfaces.ConnectionRequest;
    }
    ...
    function requestStream(cameraId, size, options, successCallback, errorCallback) {
        var connectionRequest = XPMobileSDKTunnel.library.Connection.requestStream(cameraId, size, options, successCallback, errorCallback);
        return connectionRequest || XPMobileSDKTunnel.interfaces.ConnectionRequest;
    }
    ...
    function RequestStream(params, successCallback, failCallback) {
        XPMobileSDKTunnel.library.Connection.RequestStream(params, successCallback, failCallback);
    }
    ...
    function RequestAudioStream(params, successCallback, failCallback) {
        XPMobileSDKTunnel.library.Connection.RequestAudioStream(params, successCallback, failCallback);
    }
    ...
    function requestAudioStream(microphoneId, options, successCallback, errorCallback) {
        var connectionRequest = XPMobileSDKTunnel.library.Connection.requestAudioStream(microphoneId, options, successCallback, errorCallback);
        return connectionRequest || XPMobileSDKTunnel.interfaces.ConnectionRequest;
    }
    ...
    function requestPushStream(successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.requestPushStream(successCallback, errorCallback);
    }
    ...
    function RequestAudioStreamIn(params, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.RequestAudioStreamIn(params, successCallback, errorCallback);
    }
    ...
    function requestAudioStreamIn(itemId, options, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.requestAudioStreamIn(itemId, options, successCallback, errorCallback);
    }
    ...
    function changeStream(videoConnection, cropping, size, successCallback, errorCallback) {
        var connectionRequest = XPMobileSDKTunnel.library.Connection.changeStream(videoConnection, cropping, size, successCallback, errorCallback);
        return connectionRequest || XPMobileSDKTunnel.interfaces.ConnectionRequest;
    }
    ...
    function ChangeStream(params, successCallback, failCallback) {
        XPMobileSDKTunnel.library.Connection.ChangeStream(params, successCallback, failCallback);
    }
    ...
    function closeStream(videoId) {
        return XPMobileSDKTunnel.library.Connection.closeStream(videoId);
    }
    ...
    function closeAudioStream(streamId) {
        return XPMobileSDKTunnel.library.Connection.closeAudioStream(streamId);
    }
    ...
    function CloseStream(params, successCallback, failCallback) {
        XPMobileSDKTunnel.library.Connection.CloseStream(params, successCallback, failCallback);
    }
    ...
    function createVideoPushConnection(successCallback, errorCallback, skipUserMedia) {
        var videoPushConnection = new XPMobileSDKTunnel.library.VideoPushConnection(successCallback, errorCallback, skipUserMedia);
        return videoPushConnection || XPMobileSDKTunnel.interfaces.VideoPushConnection;
    }
    ...
    function createAudioPushConnection(itemIds, sampleRate, successCallback, errorCallback) {
        var audioPushConnection = new XPMobileSDKTunnel.library.AudioPushConnection(itemIds, sampleRate, successCallback, errorCallback);
        return audioPushConnection || XPMobileSDKTunnel.interfaces.VideoPushConnection;
    }
    ...
    function getOsmServerAddresses(successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.getOsmServerAddresses(successCallback, errorCallback);
    }
    ...
    function getGisMapCameras(successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.getGisMapCameras(successCallback, errorCallback);
    }
    ...
    function getGisMapLocations(successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.getGisMapLocations(successCallback, errorCallback);
    }
    ...
    function motionDetection(videoConnection, options) {
        return XPMobileSDKTunnel.library.Connection.motionDetection(videoConnection, options);
    }
    ...
    function getPtzPresets(cameraId, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.getPtzPresets(cameraId, successCallback, errorCallback);
    }
    ...
    function ptzPreset(videoConnection, presetName) {
        return XPMobileSDKTunnel.library.Connection.ptzPreset(videoConnection, presetName);
    }
    ...
    function ptzTapAndHold(parameters, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.ptzTapAndHold(parameters, successCallback, errorCallback);
    }
    ...
    function ptzMove(videoConnection, direction) {
        return XPMobileSDKTunnel.library.Connection.ptzMove(videoConnection, direction);
    }
    ...
    function ptzSwipe(parameters, gestureDuration) {
        return XPMobileSDKTunnel.library.Connection.ptzSwipe(parameters, gestureDuration);
    }
    ...
    function playbackSpeed(videoConnection, speed) {
        return XPMobileSDKTunnel.library.Connection.playbackSpeed(videoConnection, speed);
    }
    ...
    function playbackSeek(videoConnection, seekType) {
        return XPMobileSDKTunnel.library.Connection.playbackSeek(videoConnection, seekType);
    }
    ...
    function playbackGoTo(videoConnection, millisecondsSinceUnixEpoch, seekType, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.playbackGoTo(videoConnection, millisecondsSinceUnixEpoch, seekType, successCallback, errorCallback);
    }
    ...
    function getThumbnail(cameraId, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.getThumbnail(cameraId, successCallback, errorCallback);
    }
    ...
    function getThumbnailByTime(params, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.getThumbnailByTime(params, successCallback, errorCallback);
    }
    ...
    function getDBStartTime(cameraId, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.getDBStartTime(cameraId, successCallback, errorCallback);
    }
    ...
    function getNextSequence(cameraId, timestamp, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.getNextSequence(cameraId, timestamp, successCallback, errorCallback);
    }
    ...
    function getPrevSequence(cameraId, timestamp, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.getPrevSequence(cameraId, timestamp, successCallback, errorCallback);
    }
    ...
    function getSequencesInInterval(cameraId, startTime, endTime, investigationId, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.getSequencesInInterval(cameraId, startTime, endTime, investigationId, successCallback, errorCallback);
    }
    ...
    function startVideoExport(cameraId, startTime, endTime, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.startVideoExport(cameraId, startTime, endTime, successCallback, errorCallback);
    }
    ...
    function startImageExport(cameraId, startTime, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.startImageExport(cameraId, startTime, successCallback, errorCallback);
    }
    ...
    function restartErroneousExport(exportId, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.restartErroneousExport(exportId, successCallback, errorCallback);
    }
    ...
    function getUserExports(successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.getUserExports(successCallback, errorCallback);
    }
    ...
    function getAllExports(successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.getAllExports(successCallback, errorCallback);
    }
    ...
    function getExport(id, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.getExport(id, successCallback, errorCallback);
    }
    ...
    function createExportDownloadLink(exportId, investigationId, exportType, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.createExportDownloadLink(exportId, investigationId, exportType, successCallback, errorCallback);
    }
    ...
    function deleteExport(id, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.deleteExport(id, successCallback, errorCallback);
    }
    ...
    function getOutputsAndEvents(successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.getOutputsAndEvents(successCallback, errorCallback);
    }
    ...
    function getServerStatus(successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.getServerStatus(successCallback, errorCallback);
    }
    ...
    function triggerOutputOrEvent(objectId, triggerType, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.triggerOutputOrEvent(objectId, triggerType, successCallback, errorCallback);
    }
    ...
    function getCameraCapabilities(cameraId, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.getCameraCapabilities(cameraId, successCallback, errorCallback);
    }
    ...
    function prepareUpload(parameters, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.prepareUpload(parameters, successCallback, errorCallback);
    }
    ...
    function getUploadStatus(parameters, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.getUploadStatus(parameters, successCallback, errorCallback);
    }
    ...
    function requestChallenges(parameters, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.requestChallenges(parameters, successCallback, errorCallback);
    }
    ...
    function createPlaybackController(parameters, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.createPlaybackController(parameters, successCallback, errorCallback);
    }
    ...
    function changeMultipleStreams(parameters, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.changeMultipleStreams(parameters, successCallback, errorCallback);
    }
    ...
    function getAllInvestigations(successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.getAllInvestigations(successCallback, errorCallback);
    }
    ...
    function getUserInvestigations(successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.getUserInvestigations(successCallback, errorCallback);
    }
    ...
    function getInvestigation(id, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.getInvestigation(id, successCallback, errorCallback);
    }
    ...
    function createInvestigation(parameters, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.createInvestigation(parameters, successCallback, errorCallback);
    }
    ...
    function updateInvestigation(parameters, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.updateInvestigation(parameters, successCallback, errorCallback);
    }
    ...
    function updateInvestigationData(parameters, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.updateInvestigationData(parameters, successCallback, errorCallback);
    }
    ...
    function deleteInvestigation(investigationId, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.deleteInvestigation(investigationId, successCallback, errorCallback);
    }
    ...
    function cancelInvestigation(investigationId) {
        return XPMobileSDKTunnel.library.Connection.cancelInvestigation(investigationId);
    }
    ...
    function startInvestigationExport(investigationId, exportType, includeAudio, password, successCallback, errorCallback) {
        if (!!password) {
            password = XPMobileSDKTunnel.library.Connection.dh.encodeString(password);
        }
        return XPMobileSDKTunnel.library.Connection.startInvestigationExport(investigationId, exportType, includeAudio, password, successCallback, errorCallback);
    }
    ...
    function deleteInvestigationExport(investigationId, exportType, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.deleteInvestigationExport(investigationId, exportType, successCallback, errorCallback);
    }
    ...
    function getAlarmList(parameters, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.getAlarmList(parameters, successCallback, errorCallback);
    }
    ...
    function getAlarm(alarmId, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.getAlarm(alarmId, successCallback, errorCallback);
    }
    ...
    function updateAlarm(parameters, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.updateAlarm(parameters, successCallback, errorCallback);
    }
    ...
    function getAlarmDataSettings(successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.getAlarmDataSettings(successCallback, errorCallback);
    }
    ...
    function getAlarmUsers(alarmId, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.getAlarmUsers(alarmId, successCallback, errorCallback);
    }
    ...
    function acknowledgeAlarm(alarmId, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.acknowledgeAlarm(alarmId, successCallback, errorCallback);
    }
    ...
    function getBookmarks(parameters, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.getBookmarks(parameters, successCallback, errorCallback);
    }
    ...
    function deleteBookmark(id, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.deleteBookmark(id, successCallback, errorCallback);
    }
    ...
    function prevCarouselCamera(videoId) {
        return XPMobileSDKTunnel.library.Connection.prevCarouselCamera(videoId);
    }
    ...
    function nextCarouselCamera(videoId) {
        return XPMobileSDKTunnel.library.Connection.nextCarouselCamera(videoId);
    }
    ...
    function pauseCarousel(videoId) {
        return XPMobileSDKTunnel.library.Connection.pauseCarousel(videoId);
    }
    ...
    function resumeCarousel(videoId) {
        return XPMobileSDKTunnel.library.Connection.resumeCarousel(videoId);
    }
    ...
    function getResamplingFactor() {
        return XPMobileSDKTunnel.features.SupportsExtendedResamplingFactor && XPMobileSDKSettingsTunnel.resamplingFactor || 1;
    }
    ...
    function toggleDiagnosticsOverlay(enabled) {
        XPMobileSDKTunnel.library.Connection.toggleDiagnosticsOverlay(enabled);
    }
    ...
    function toggleAnalytics(enabled) {
        XPMobileSDKTunnel.library.Connection.toggleAnalytics(enabled);
    }
    ...
    function toggleDirectStreaming(enabled) {
        XPMobileSDKTunnel.library.Connection.toggleDirectStreaming(enabled);
    }
    ...
    function registerForNotifications(setting, successCallback, errorCallback) {
        return XPMobileSDKTunnel.library.Connection.registerForNotifications(setting, successCallback, errorCallback);
    }
    ...
    function RegisterForNotifications(params, successCallback, errorCallback) {
        XPMobileSDKTunnel.library.Connection.RegisterForNotifications(params, successCallback, errorCallback);
    }
    ...
    function CreateBookmark(params, successCallback, errorCallback) {
        XPMobileSDKTunnel.library.Connection.CreateBookmark(params, successCallback, errorCallback);
    }
    ...
    function UpdateBookmark(params, successCallback, errorCallback) {
        XPMobileSDKTunnel.library.Connection.UpdateBookmark(params, successCallback, errorCallback);
    }
    ...
    function RequestBookmarkCreation(params, successCallback, errorCallback) {
        XPMobileSDKTunnel.library.Connection.RequestBookmarkCreation(params, successCallback, errorCallback);
    }
    ...
    function sendCommand(commandName, requestParams, options, successCallback, failCallback) {
        XPMobileSDKTunnel.library.Connection.sendCommand(commandName, requestParams, options, successCallback, failCallback);
    }
     ...
     */
    function destroy() {
        XPMobileSDKTunnel.library.Connection.destroy();
    }
};
 ...
 */
XPMobileSDKTunnel.interfaces.ConnectionObserver = {
 ...
 */
XPMobileSDKTunnel.interfaces.VideoConnectionObserver = {
 ...
 */
XPMobileSDKTunnel.interfaces.ConnectionRequest = {
 ...
 * @var {Number} playback
 */
XPMobileSDKTunnel.interfaces.VideoConnectionSignal = {
 ...
 */
XPMobileSDKTunnel.interfaces.VideoConnectionSize = {
 ...
 */
XPMobileSDKTunnel.interfaces.VideoConnectionOptions = {

    signal: XPMobileSDKTunnel.interfaces.VideoConnectionSignal.live,
    time: Number(),
 ...
 */
XPMobileSDKTunnel.interfaces.VideoConnectionCropping = {
 ...
 */
XPMobileSDKTunnel.interfaces.VideoConnection = {
 ...
 */
XPMobileSDKTunnel.interfaces.VideoPushConnection = {
