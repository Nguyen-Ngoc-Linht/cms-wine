...
export default class Stream {
    ...
    receivedFragment(fragment) {
        ...
        this.fallbackController.addFragment(fragment); // we need to notify.js the fallback controller that we receive frames even that they are not of the supported data types
